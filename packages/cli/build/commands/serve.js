...
export const builder = (yargs) => yargs
    ...
    .option("open", {
    describe: "Open web server root directory in default browser. " +
    ...
    describe: "Always send content security policies 'sap-target-level-1' and " +
    ...
    .example("ui5 serve --translator static:/path/to/projectDependencies.yaml", "Use a \"static\" translator with translator parameters.")
    .example("ui5 serve --port 1337 --open tests/QUnit.html", "Listen to port 1337 and launch default browser with http://localhost:1337/test/QUnit.html");
export const handler = async (argv) => {
    ...
    if (argv.acceptRemoteConnections) {
        ...
        console.log(chalk.bold.dim("* This server is intended for development purposes only. Do not use it in production."));
        console.log(chalk.dim("* Vulnerable (custom-)middleware can pose a threat to your system when exposed to the network"));
        console.log(chalk.dim("* The use of proxy-middleware with preconfigured credentials might enable unauthorized access " +
