...
export class AbstractReaderWriter extends AbstractReader {
	 ...
	 */
	write(resource: any, options = {drain: false, readOnly: false}) {
	 ...
	 * @abstract
	 * @protected
	 * @param {module:@ui5/fs.Resource} _resource Resource to write
	 * @param {object} [_options] Write options, see above
	 * @returns {Promise<undefined>} Promise resolving once data has been written
	 */
	_write(_resource: any, _options: {
			/**
			 * Abstract resource locator
			 *
			 * @public
			 ...
			 * @augments module:@ui5/fs.AbstractReader
			 */
			drain: boolean; readOnly: boolean;
		}) {
