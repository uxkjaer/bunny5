...
export default class ReaderCollection extends AbstractReader {
	 ...
	 */
	_byGlob(pattern: any, options: any, trace: { collection: (arg0: any) => void; }) {
		return Promise.all(this._readers.map(function(resourceLocator: { _byGlob: (arg0: any, arg1: any, arg2: { collection: (arg0: any) => void; }) => any; }) {
	 ...
	 */
	_byPath(virPath: any, options: any, trace: { collection: (arg0: any) => void; }) {
		const that = this;
		...
		*/
		return Promise.race(this._readers.map(function(resourceLocator: { _byPath: (arg0: any, arg1: any, arg2: any) => Promise<any>; }) {
			return resourceLocator._byPath(virPath, options, trace).then(function(resource: any) {
